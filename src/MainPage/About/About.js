        ...
        return (
            <div className="aboutWrapper" >
                ...
                <div className="aboutInfo">
                    ...
                    <p ref={p => this.paragraphTwo = p}>With the ever-changing world of Web Development, I am incredibly eager to learn new, more efficient ways to create. I like writing clean, modular code, which is the basis for JavaScript frameworks like React.JS. When I am not coding, you can find me on my bike exploring the weird parts of Toronto.</p>
                </div>
            </div>
        )
    }
